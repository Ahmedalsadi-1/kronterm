...
export type RuntimePlatform = 'web' | 'desktop' | 'vscode' | 'extension';
...
export interface SettingsPayload {
  ...
  agentMode?: 'off' | 'sandbox' | 'openbrowser' | 'native';
  agentModeByProject?: Record<string, 'sandbox' | 'openbrowser' | 'native'>;
