...
The active Hermes migration is pinned by `hermes-agent.lock.json`. Its ignored local checkout lives at `third_party/upstream/hermes-agent` and is a reference source only.
