    ...
    return (
        <div className="space-y-6">
            ...
            <p className="text-xs text-muted-foreground">
                Voice features require browser microphone access. Full voice control with speech-to-text and read-aloud
                responses is available when connected to a supported AI provider.
            </p>
        </div>
    );
};
