                ...
                <>
                    <div className="flex items-center justify-between">
                        <div className="space-y-0.5">
                            ...
                            <p className="text-xs text-muted-foreground">
                                When off, only notify when you are not looking at KronTerm.
                            </p>
                        </div>
                        <Switch
                    ...
                    <div className="space-y-3">
                        ...
                        {[
                            {
                                label: "Completion",
                                desc: "Agent finished its task.",
                                checked: notifyOnCompletion,
                                onChange: setNotifyOnCompletion,
                            },
                            {
                                label: "Errors",
                                desc: "A tool call failed.",
                                checked: notifyOnError,
                                onChange: setNotifyOnError,
                            },
                            {
                                label: "Questions",
                                desc: "Agent is asking for input or permission.",
                                checked: notifyOnQuestion,
                                onChange: setNotifyOnQuestion,
                            },
                            {
                                label: "Subagents",
                                desc: "Also notify for child sessions.",
                    ...
                    <div className="space-y-4 pt-2">
                        <div className="space-y-1">
                            ...
                            <p className="text-xs text-muted-foreground">
                                Use template variables: {"{project_name}"} {"{branch}"} {"{agent_name}"}{" "}
                                {"{last_message}"}
                            </p>
                        </div>
