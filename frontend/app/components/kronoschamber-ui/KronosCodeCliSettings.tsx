    ...
    React.useEffect(() => {
        ...
        void (async () => {
            try {
                ...
                const nextAiBrowserEnabled = typeof data.aiBrowserEnabled === "boolean" ? data.aiBrowserEnabled : false;
        ...
        <div className="space-y-3">
            <div className="space-y-1">
                ...
                <p className="text-sm text-muted-foreground">
                    Optional absolute path to the <code className="font-mono text-xs">kronoscode</code> binary. Useful
                    when your desktop app launch environment has a stale PATH.
                </p>
            </div>
            ...
            <div className="flex items-start justify-between gap-3 rounded-lg border border-border/60 px-3 py-2">
                <div className="space-y-1">
                    ...
                    <p className="text-xs text-muted-foreground">
                        Sets <span className="font-mono">KRONOSCODE_ENABLE_AI_BROWSER</span> for managed KronosCode
                        restarts.
                    </p>
                </div>
                <Switch
