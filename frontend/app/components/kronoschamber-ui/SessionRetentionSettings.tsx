...
import { autoDeleteAfterDaysAtom, autoDeleteEnabledAtom } from "@/stores/kronosChamberSettingsStore";
                ...
                <div className="flex items-center gap-2">
                    ...
                    <Tooltip delayDuration={1000}>
                        ...
                        <TooltipContent sideOffset={8} className="max-w-xs">
                            Automatically delete inactive sessions based on their last activity. Keeps the most recent 5
                            sessions.
                        </TooltipContent>
                    </Tooltip>
                </div>
