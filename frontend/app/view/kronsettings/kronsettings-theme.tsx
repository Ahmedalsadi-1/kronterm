        ...
        <div>
                    ...
                    {THEME_PRESETS.map((preset) => (
                        <button
                            ...
                            style={{
                                ...
                                background:
                                    selectedPreset === preset.id ? "var(--surface-selected-color)" : "transparent",
                                cursor: "pointer",
                        ...
                        >
                            <div
                                style={{
                                    ...
                                    boxShadow:
                                        selectedPreset === preset.id
                                            ? `0 0 8px ${preset.colors["--accent-color"]}60`
                                            : "none",
                                }}
                            />
            ...
            <SettingsCard>
                <SectionHeader
                    title="Custom Accent"
                    icon="eye-dropper"
                    description="Pick a custom accent color for full control."
                />
