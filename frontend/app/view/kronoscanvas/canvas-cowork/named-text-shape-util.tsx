            ...
            >
                ...
                <div
                    style={{
                        ...
                        border: "1px solid",
                        borderColor: isSelected ? "var(--color-selected, #3b82f6)" : "var(--color-text-3, #ccc)",
                        borderRadius: 6,
                        overflow: "hidden",
                    }}
                >
...
function NameLabel({ shapeId, name, isSelected }: { shapeId: TLShapeId; name: string; isSelected: boolean }) {
    const editor = useEditor();
    const inputRef = useRef<HTMLInputElement>(null);
    const isEditingName = useValue(
        "isEditingName",
        () => {
