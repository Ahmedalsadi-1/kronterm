...
/**
 * Safari browser window mockup — renders content inside an SVG Safari frame.
 * Supports image, video, or empty screen area with dark/light auto-theming.
 */
const Safari = ({
    imageSrc,
    videoSrc,
...
export { Safari, type SafariProps };
