...
function createMockFilesystemEntries(): MockFsEntryInput[] {
    const entries: MockFsEntryInput[] = [
        ...
        { path: `${MockHomePath}/kronterm`, isdir: true },
        { path: `${MockHomePath}/kronterm/docs`, isdir: true },
        { path: `${MockHomePath}/kronterm/images`, isdir: true },
        ...
        makeMockFsInput(`${MockHomePath}/Downloads/kronterm-nightly.dmg`),
        ...
        makeMockFsInput(
            `${MockHomePath}/kronterm/README.md`,
            `# Mock WaveTerm Repo\n\nThis fake repo exists only in the preview environment.\nIt gives file previews something realistic to browse.\n`,
            "text/markdown"
        ),
        makeMockFsInput(`${MockHomePath}/kronterm/package.json`),
        makeMockFsInput(`${MockHomePath}/kronterm/tsconfig.json`),
        makeMockFsInput(`${MockHomePath}/kronterm/Taskfile.yml`),
        makeMockFsInput(`${MockHomePath}/kronterm/preview-model.tsx`),
        makeMockFsInput(`${MockHomePath}/kronterm/mockwaveenv.ts`),
        makeMockFsInput(`${MockHomePath}/kronterm/vite.config.ts`),
        makeMockFsInput(`${MockHomePath}/kronterm/CHANGELOG.md`),
        makeMockFsInput(
            `${MockHomePath}/kronterm/docs/preview-notes.md`,
        ...
        makeMockFsInput(`${MockHomePath}/kronterm/docs/filesystem-rpc.md`),
        makeMockFsInput(`${MockHomePath}/kronterm/docs/test-plan.md`),
        makeMockFsInput(`${MockHomePath}/kronterm/docs/connections.md`),
        makeMockFsInput(`${MockHomePath}/kronterm/docs/preview-gallery.md`),
        makeMockFsInput(`${MockHomePath}/kronterm/docs/release-notes.md`),
        makeMockFsInput(`${MockHomePath}/kronterm/images/wave-logo.png`, TinyPngBytes, "image/png"),
        makeMockFsInput(`${MockHomePath}/kronterm/images/hero.png`),
        makeMockFsInput(`${MockHomePath}/kronterm/images/avatar.jpg`),
        makeMockFsInput(`${MockHomePath}/kronterm/images/icon-16.png`),
        makeMockFsInput(`${MockHomePath}/kronterm/images/icon-32.png`),
        makeMockFsInput(`${MockHomePath}/kronterm/images/splash.jpg`),
        makeMockFsInput(
