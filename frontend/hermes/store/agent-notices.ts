import type { NativeNotificationInput } from '@hermes/store/native-notifications'
import { dismissNotification, type NotificationInput, type NotificationKind, notify } from '@hermes/store/notifications'
