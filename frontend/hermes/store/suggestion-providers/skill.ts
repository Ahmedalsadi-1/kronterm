...
import { getSkills } from '@hermes/hermes'
import { translateNow } from '@hermes/i18n'
import type { ChatMessage } from '@hermes/lib/chat-messages'
import { type ComposerSuggestion, registerDraftProvider } from '@hermes/store/composer-suggestions'
import { $activeSessionId, $currentCwd, $messages } from '@hermes/store/session'
