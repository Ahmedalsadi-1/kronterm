...
import { deriveDraftTitle } from "@hermes/lib/draft-title";
...
export interface ComposerAttachment {
    ...
    occurrenceId?: string;
    kind: "canvas" | "file" | "folder" | "image" | "review" | "terminal" | "url";
    label: string;
    detail?: string;
    refText?: string;
    ...
    /** Identifies attachments managed by an external surface integration. */
    source?: "kronterm-canvas";
    /** Stable source identity used to reconcile managed attachments. */
    sourceId?: string;
    sourceMode?: "follow" | "quote";
    sourceTabId?: string;
...
export const ComposerAttachmentUserRemovedEvent = "hermes:composer-attachment-user-removed";

export function publishComposerAttachmentUserRemoved(attachment: ComposerAttachment): void {
    window.dispatchEvent(
        new CustomEvent<ComposerAttachment>(ComposerAttachmentUserRemovedEvent, { detail: attachment })
    );
}
