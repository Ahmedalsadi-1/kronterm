...
import { lastVisibleMessageIsUser } from '@hermes/app/chat/thread-loading'
import type { ContextSuggestion } from '@hermes/app/types'
import type { HermesConnection } from '@hermes/global'
import type { ChatMessage } from '@hermes/lib/chat-messages'
import { persistBoolean, persistString, storedBoolean, storedString } from '@hermes/lib/storage'
import { syncCronModelImpactConnection } from '@hermes/store/cron-model-impact-scope'
import type { SessionInfo, UsageStats } from '@hermes/types/hermes'
