...
import { DiffusionCanvas } from '@hermes/components/chat/image-generation-placeholder'
import { ImageActionButton, ImageLightbox } from '@hermes/components/chat/zoomable-image'
...
import { filePathFromMediaPath, gatewayMediaDataUrl, isRemoteGateway, mediaExternalUrl, mediaName } from '@hermes/lib/media'
