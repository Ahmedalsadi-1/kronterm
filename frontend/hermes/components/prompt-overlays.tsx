...
import { PendingApprovalFallback } from '@hermes/components/assistant-ui/tool/approval'
...
import { isMissingPendingPromptRequest } from '@hermes/lib/gateway-rpc'
import { triggerHaptic } from '@hermes/lib/haptics'
import { KeyRound, Loader2, Lock } from '@hermes/lib/icons'
import { $gateway } from '@hermes/store/gateway'
import { notifyError } from '@hermes/store/notifications'
import { clearSecretRequest, clearSudoRequest, sessionSecretRequest, sessionSudoRequest } from '@hermes/store/prompts'
