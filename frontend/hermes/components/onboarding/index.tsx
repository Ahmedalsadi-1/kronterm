...
import { getGlobalModelOptions } from '@hermes/hermes'
import { useI18n } from '@hermes/i18n'
import { Check, ChevronDown, ChevronLeft, KeyRound, Loader2 } from '@hermes/lib/icons'
import { isProviderSetupErrorMessage } from '@hermes/lib/provider-setup-errors'
import { cn } from '@hermes/lib/utils'
import { $desktopBoot, type DesktopBootState } from '@hermes/store/boot'
import {
  $desktopOnboarding,
  ...
  setOnboardingMode,
  startProviderOAuth
} from '@hermes/store/onboarding'
import type { ModelOptionProvider, OAuthProvider } from '@hermes/types/hermes'
