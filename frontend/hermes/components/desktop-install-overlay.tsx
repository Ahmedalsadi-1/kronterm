...
import { ErrorIcon } from '@hermes/components/ui/error-state'
import { Loader } from '@hermes/components/ui/loader'
import { LogView } from '@hermes/components/ui/log-view'
...
import { AlertCircle, ChevronDown, ChevronRight, Globe, iconSize, Loader2, Monitor } from '@hermes/lib/icons'
import { capitalize } from '@hermes/lib/text'
 ...
 *
 * Renders the first-launch install progress for KronTerm. Mounted always;
...
export function DesktopInstallOverlay({ enabled = true }: DesktopInstallOverlayProps) {
  ...
  // there's no KronTerm installed yet and we can't drive install.sh
