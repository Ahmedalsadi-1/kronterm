...
import type { DesktopConnectionConfig } from '@hermes/global'
import { useI18n } from '@hermes/i18n'
import { ChevronLeft, FileText, Loader2, LogIn, RefreshCw, SlidersHorizontal, Wrench } from '@hermes/lib/icons'
import { $desktopBoot } from '@hermes/store/boot'
import { notify, notifyError } from '@hermes/store/notifications'
import { $desktopOnboarding } from '@hermes/store/onboarding'
...
const GatewaySettings = lazy(() =>
  import('@hermes/app/settings/gateway-settings').then(module => ({ default: module.GatewaySettings }))
)
