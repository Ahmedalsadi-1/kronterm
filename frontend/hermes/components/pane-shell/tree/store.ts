...
import { setPluginEnabled } from '@hermes/contrib/plugins-store'
import { registry } from '@hermes/contrib/registry'
import { translateNow } from '@hermes/i18n'
import { readJson, readKey, writeJson, writeKey } from '@hermes/lib/storage'
import { notify } from '@hermes/store/notifications'
import { clearAllPaneSizeOverrides } from '@hermes/store/panes'
