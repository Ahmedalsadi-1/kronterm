...
import { DirectiveContent } from '@hermes/components/assistant-ui/directive-text'
import { messageAttachmentRefs, messageContentText } from '@hermes/components/assistant-ui/thread/content'
import { ReactionBadge, ReactionPicker } from '@hermes/components/assistant-ui/thread/message-reactions'
import { MessageTimelineTimestamp } from '@hermes/components/assistant-ui/thread/timeline-timestamp'
import { type RestoreMessageTarget } from '@hermes/components/assistant-ui/thread/types'
import { useMessageReactions } from '@hermes/components/assistant-ui/thread/use-message-reactions'
import { UserMessageText } from '@hermes/components/assistant-ui/thread/user-message-text'
import { Codicon } from '@hermes/components/ui/codicon'
import { useResizeObserver } from '@hermes/hooks/use-resize-observer'
import { useI18n } from '@hermes/i18n'
import { triggerHaptic } from '@hermes/lib/haptics'
import { StopFilled } from '@hermes/lib/icons'
import { cn } from '@hermes/lib/utils'
import { $gateway } from '@hermes/store/gateway'
import { notifyThreadEditOpen } from '@hermes/store/thread-scroll'
