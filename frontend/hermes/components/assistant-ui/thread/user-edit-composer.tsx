...
import { ComposerDirectiveActions } from '@hermes/app/chat/composer/directive-actions'
import { COMPOSER_DROP_ACTIVE_CLASS, COMPOSER_DROP_FADE_CLASS } from '@hermes/app/chat/composer/drop-affordance'
import {
...
} from '@hermes/app/chat/composer/focus'
import { useAtCompletions } from '@hermes/app/chat/composer/hooks/use-at-completions'
import { rebuildAroundCaret } from '@hermes/app/chat/composer/hooks/use-composer-trigger'
import { useComposerUndo } from '@hermes/app/chat/composer/hooks/use-composer-undo'
import { useEmojiCompletions } from '@hermes/app/chat/composer/hooks/use-emoji-completions'
import { useSlashCompletions } from '@hermes/app/chat/composer/hooks/use-slash-completions'
import {
  dragHasAttachments,
  droppedFileInlineRefs,
  type InlineRefInput,
  insertInlineRefsIntoEditor
} from '@hermes/app/chat/composer/inline-refs'
import { chipTypedPathOnSpace, pathifyRefs } from '@hermes/app/chat/composer/path-refs'
import {
  composerPlainText,
  ...
  replaceBeforeCaret,
  RICH_INPUT_SLOT
} from '@hermes/app/chat/composer/rich-editor'
import { detectTrigger, openDirectiveScope, textBeforeCaret, type TriggerState } from '@hermes/app/chat/composer/text-utils'
import { ComposerTriggerPopover } from '@hermes/app/chat/composer/trigger-popover'
import { isRedoShortcut, isUndoShortcut } from '@hermes/app/chat/composer/undo-history'
import { chipTypedUrlOnSpace, linkifyUrls } from '@hermes/app/chat/composer/url-refs'
import {
  extractDroppedFiles,
  HERMES_PATHS_MIME,
  isImagePath,
  partitionDroppedFiles
} from '@hermes/app/chat/hooks/use-composer-actions'
import { uploadComposerAttachment } from '@hermes/app/session/hooks/use-prompt-actions'
...
} from '@hermes/components/assistant-ui/thread/user-message'
...
import { attachmentDisplayText, attachmentId, pathLabel } from '@hermes/lib/chat-runtime'
import { sanitizeComposerInput } from '@hermes/lib/composer-input-sanitize'
import { DATA_IMAGE_URL_RE } from '@hermes/lib/embedded-images'
import { triggerHaptic } from '@hermes/lib/haptics'
import { Loader2Icon } from '@hermes/lib/icons'
...
import { $connection, $terminalBackend } from '@hermes/store/session'
import { notifyThreadEditClose } from '@hermes/store/thread-scroll'
