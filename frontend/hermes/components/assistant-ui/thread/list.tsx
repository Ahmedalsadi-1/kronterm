...
import { usePaneLifecycle } from '@hermes/components/pane-shell/pane-visibility'
import { useI18n } from '@hermes/i18n'
import { messagePaintWeight } from '@hermes/lib/render-weight'
...
import {
  ...
  resetThreadScroll,
  setThreadAtBottom
} from '@hermes/store/thread-scroll'
