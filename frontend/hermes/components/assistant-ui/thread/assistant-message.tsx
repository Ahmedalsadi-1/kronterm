...
import { ChangedFilesCard } from '@hermes/components/assistant-ui/thread/changed-files-card'
import {
  contentHasVisibleText,
  messageContentText,
  pickPrimaryPreviewTarget
} from '@hermes/components/assistant-ui/thread/content'
import { MESSAGE_PARTS_COMPONENTS } from '@hermes/components/assistant-ui/thread/message-parts'
import { ReactionPicker } from '@hermes/components/assistant-ui/thread/message-reactions'
import { ResponseLoadingIndicator, StreamStallIndicator } from '@hermes/components/assistant-ui/thread/status'
import { MessageTimelineTimestamp } from '@hermes/components/assistant-ui/thread/timeline-timestamp'
import { useMessageReactions, useTapbackDoubleClick } from '@hermes/components/assistant-ui/thread/use-message-reactions'
import { AGENT_MESSAGE_RE } from '@hermes/components/assistant-ui/thread/user-message'
import { TooltipIconButton } from '@hermes/components/assistant-ui/tooltip-icon-button'
import { formatElapsed } from '@hermes/components/chat/activity-timer'
import { PreviewAttachment } from '@hermes/components/chat/preview-attachment'
...
import { AudioLines, GitForkIcon, Loader2Icon, RefreshCwIcon, SmilePlusIcon, VolumeXIcon, XIcon } from '@hermes/lib/icons'
import { extractPreviewTargets } from '@hermes/lib/preview-targets'
import { useEnterAnimation } from '@hermes/lib/use-enter-animation'
import { cn } from '@hermes/lib/utils'
import { playSpeechText, stopVoicePlayback } from '@hermes/lib/voice-playback'
import { notifyError } from '@hermes/store/notifications'
import { $voicePlayback } from '@hermes/store/voice-playback'
