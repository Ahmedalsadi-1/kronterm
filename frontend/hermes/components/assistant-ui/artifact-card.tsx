...
import { CodeCardIcon } from '@hermes/components/chat/code-card'
import { WIDGET_SHELL_CLASS } from '@hermes/components/chat/widget-shell'
import { useI18n } from '@hermes/i18n'
import type { ArtifactDetection } from '@hermes/lib/artifact-detect'
import { codiconForLanguage } from '@hermes/lib/markdown-code'
import { cn } from '@hermes/lib/utils'
import { $artifactRegistry, artifactsForSession, openArtifact, upsertArtifact } from '@hermes/store/artifacts'
