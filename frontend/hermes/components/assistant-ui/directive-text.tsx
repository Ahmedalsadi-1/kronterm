...
import type { I18nContextValue } from '@hermes/i18n'
import { extractEmbeddedImages } from '@hermes/lib/embedded-images'
import { openExternalLink } from '@hermes/lib/external-link'
import { triggerHaptic } from '@hermes/lib/haptics'
import { gatewayMediaDataUrl, isRemoteGateway } from '@hermes/lib/media'
import { useSessionLinkTitle } from '@hermes/lib/session-link-title'
import { parseSessionRefValue, sessionRefFallbackLabel } from '@hermes/lib/session-refs'
...
export function openSessionRef(value: string) {
  ...
  void import('@hermes/app/open-session').then(({ openSession }) => openSession(sessionId, () => undefined, 'tab'))
}
