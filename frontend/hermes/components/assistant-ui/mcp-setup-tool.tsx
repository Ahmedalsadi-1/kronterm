...
import { ToolFallback } from '@hermes/components/assistant-ui/tool/fallback'
import { WIDGET_SHELL_CLASS } from '@hermes/components/chat/widget-shell'
...
import { AlertCircle, CheckCircle2, Loader2 } from '@hermes/lib/icons'
import { brandFor, brandGlyphStyle } from '@hermes/lib/mcp-brands'
import { completeMcpDesktopOAuth, McpOAuthCancelled } from '@hermes/lib/mcp-dashboard-oauth'
import { directoryEntry } from '@hermes/lib/mcp-directory'
import { prettyName } from '@hermes/lib/text'
import { cn } from '@hermes/lib/utils'
import { $gateway } from '@hermes/store/gateway'
import { clearMcpSetupRequest, type McpSetupOutcome, sessionMcpSetupRequest } from '@hermes/store/mcp-setup'
import { notifyError } from '@hermes/store/notifications'
import { invalidateMcpSuggestionIndex } from '@hermes/store/suggestion-providers/mcp'
