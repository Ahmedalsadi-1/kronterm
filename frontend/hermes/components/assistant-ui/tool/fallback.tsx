...
import { useSessionView } from '@hermes/app/chat/session-view'
import { AnsiText } from '@hermes/components/assistant-ui/ansi-text'
import { TimelineTimestamp } from '@hermes/components/assistant-ui/thread/timeline-timestamp'
import { useElapsedSeconds } from '@hermes/components/chat/activity-timer'
import { ActivityTimerText } from '@hermes/components/chat/activity-timer-text'
import { CompactMarkdown } from '@hermes/components/chat/compact-markdown'
import { FileDiffPanel } from '@hermes/components/chat/diff-lines'
import { DisclosureRow } from '@hermes/components/chat/disclosure-row'
import { SCAFFOLD_LABEL_CLASS, SCAFFOLD_META_CLASS, ScaffoldRow } from '@hermes/components/chat/scaffold-row'
import { ZoomableImage } from '@hermes/components/chat/zoomable-image'
import { Button } from '@hermes/components/ui/button'
import { Codicon } from '@hermes/components/ui/codicon'
import { CopyButton } from '@hermes/components/ui/copy-button'
import { DisclosureCaret } from '@hermes/components/ui/disclosure-caret'
import { FadeText } from '@hermes/components/ui/fade-text'
import { FileTypeIcon } from '@hermes/components/ui/file-type-icon'
import { GlyphSpinner } from '@hermes/components/ui/glyph-spinner'
import { ToolIcon } from '@hermes/components/ui/tool-icon'
import { Tip } from '@hermes/components/ui/tooltip'
import { useI18n } from '@hermes/i18n'
import { PrettyLink, LinkifiedText as SharedLinkifiedText, urlSlugTitleLabel } from '@hermes/lib/external-link'
import { AlertCircle, CheckCircle2 } from '@hermes/lib/icons'
import { normalize } from '@hermes/lib/text'
import { useEnterAnimation } from '@hermes/lib/use-enter-animation'
import { cn } from '@hermes/lib/utils'
import { recordPreviewArtifact } from '@hermes/store/preview-status'
import { sessionApprovalRequest } from '@hermes/store/prompts'
import { $toolInlineDiff } from '@hermes/store/tool-diffs'
import { $toolRowDismissed, dismissToolRow } from '@hermes/store/tool-dismiss'
import { $anyToolDisclosureOpen, $toolDisclosureOpen, $toolViewMode, setToolDisclosureOpen } from '@hermes/store/tool-view'
