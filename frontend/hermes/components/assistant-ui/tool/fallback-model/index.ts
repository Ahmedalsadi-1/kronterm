import { type ToolTitleKey, translateNow } from '@hermes/i18n'
import { normalizeExternalUrl } from '@hermes/lib/external-link'
import { summarizeShellCommand } from '@hermes/lib/summarize-command'
import { capitalize, normalize } from '@hermes/lib/text'
import { isCardTool, isFileEditTool, isSilentTool } from '@hermes/lib/tool-render-class'
import { extractToolErrorMessage, formatToolResultSummary } from '@hermes/lib/tool-result-summary'
