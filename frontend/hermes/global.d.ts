    ...
    interface Window {
        hermesDesktop: {
            ...
            connections: {
                ...
                save: (payload: DesktopRegistryConnectionInput) => Promise<{
                    ok: boolean;
...
export interface HermesKronTermSurface {
    id: string;
    view: string;
    title: string;
    focused: boolean;
...
export interface HermesKronTermInspectableElement {
    ref: string;
    role: string;
    name: string;
    value?: string;
...
export interface HermesKronTermInspectableSnapshot {
    ...
    height: number;
    timestamp: number;
    elements: HermesKronTermInspectableElement[];
}
