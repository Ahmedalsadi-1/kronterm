import { FIELD_DESCRIPTIONS, FIELD_LABELS } from '@hermes/app/settings/constants'
...
export const en: Translations = {
  ...
  boot: {
    ready: 'KronTerm Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading KronTerm settings',
      loadingSessions: 'Loading recent sessions',
      startingDesktopConnection: 'Starting desktop connection',
      startingHermesDesktop: 'Starting KronTerm Desktop…'
    },
    errors: {
      backgroundExited: 'KronTerm background process exited.',
      backgroundExitedDuringStartup: 'KronTerm background process exited during startup.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your KronTerm backend is older than this desktop build and may not work correctly. Update to align them.',
    installMethodUnsupportedTitle: 'Unsupported install method',
    updateHermes: 'Update KronTerm',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting KronTerm Desktop.',
    ...
    native: {
      ...
      inputBody: 'KronTerm is waiting for your response.',
      turnDoneTitle: 'KronTerm finished',
      turnDoneBody: '',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to KronTerm defaults?',
    ...
    plugins: {
      ...
      agent: {
        title: 'Agent plugins',
        blurb:
          'Run in the KronTerm backend — tools, skills, MCP servers, hooks, and slash commands. Portable ones are Agent Plugins packages (skills + MCP bundles that work in other agents too). Toggles apply to new sessions.',
        ...
        updateBackendToManage: 'Update the KronTerm backend to manage this plugin from Desktop.',
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while KronTerm is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'KronTerm asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while KronTerm was in the background.'
        },
        turnError: {
          label: 'Turn failed',
        ...
        plugin: {
          ...
          description: 'A desktop plugin sent a notification while KronTerm was in the background.'
        }
      },
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let KronTerm follow your system setting.',
      ...
      reactionsDesc: 'iMessage-style emoji tapbacks — react to messages, and KronTerm can react to yours.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what KronTerm is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen KronTerm, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    about: {
      ...
      automaticUpdatesDesc:
        'KronTerm checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading KronTerm configuration...',
    ...
    quickEntry: {
      ...
      enabledDesc:
        'Summon a small composer from anywhere with a global shortcut and fire a prompt without opening KronTerm.',
    ...
    connections: {
      title: 'Connections',
      intro:
        'Register every place your agents live — this device, remote gateways on your network, and KronTerm Cloud instances. All of them are stored here.',
      stagedNote:
      ...
      updateSkippedCloud: 'Managed by KronTerm Cloud',
      kindLocal: 'Local',
      kindRemote: 'Remote gateway',
      kindCloud: 'KronTerm Cloud',
      kindSsh: 'SSH',
      kindLocalDesc: 'The KronTerm runtime managed by this app.',
      kindRemoteDesc: 'A KronTerm gateway reachable over HTTP(S) — LAN, Tailscale, or the internet.',
      kindCloudDesc: 'A hosted instance discovered through your KronTerm Cloud account.',
      kindSshDesc: 'A KronTerm install reached over SSH.',
      labelTitle: 'Name',
    ...
    gateway: {
      ...
      intro:
        'Local by default. Use remote when this app should drive a KronTerm backend elsewhere. Per-profile overrides below.',
      ...
      localDesc: 'Start a private KronTerm backend on localhost. This is the default and works offline.',
      inheritTitle: 'Use default gateway',
      inheritDesc: "Remove this profile's override and use the default connection.",
      remoteTitle: 'Remote gateway',
      remoteDesc: 'Connect this desktop shell to a remote KronTerm backend.',
      remoteAuthHint: 'Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      cloudTitle: 'KronTerm Cloud',
      cloudDesc: 'Sign in once to KronTerm Cloud and pick from the agents on your account — no URL to paste.',
      cloudSignInTitle: 'KronTerm Cloud',
      cloudSignIn: 'Sign in to KronTerm Cloud',
      cloudSignedIn: 'Signed in to KronTerm Cloud',
      cloudNeedsSignIn: 'Sign in to KronTerm Cloud to discover the agents on your account.',
      ...
      cloudDiscoverFailed: 'Could not load your KronTerm Cloud agents',
      cloudConnectFailed: 'Could not connect to that agent',
      cloudSignInFailed: 'KronTerm Cloud sign-in failed',
      cloudSignedOutTitle: 'Signed out of KronTerm Cloud',
      cloudSignedOutMessage: 'Cleared the KronTerm Cloud session.',
      ...
      restartingMessage: 'KronTerm Desktop will reconnect using the saved settings — the shell stays open.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · KronTerm ${version}` : ''}`,
      ...
      sshDesc:
        'KronTerm is launched on the remote over SSH and tunneled to this app — nothing to start or expose yourself. Requires working key-based SSH access to the host.',
      ...
      sshHermesPathTitle: 'KronTerm path (optional)',
      ...
      sshReachable: (host, platform) => `Reachable: ${host} (${platform}) — KronTerm found`,
      ...
      sshErrAuth:
        'SSH authentication failed. Load your key into the ssh-agent (ssh-add) or set an IdentityFile in ~/.ssh/config — KronTerm runs ssh non-interactively.',
      sshErrHostKey:
        'The host key has CHANGED since you last connected. Verify this is expected, then run ssh-keygen -R <host> and reconnect.',
      sshErrNotInstalled:
        'KronTerm is not installed on the remote host. Install it there (curl -fsSL https://hermes-agent.nousresearch.com/install.sh | sh) or set the KronTerm path.',
      sshErrPlatform:
        'Unsupported remote platform. KronTerm Desktop SSH mode supports Linux, macOS, and Windows remote hosts.',
      sshErrTimeout: 'SSH connection timed out. The host may be unreachable or asleep.',
      sshErrUpdateRequired: 'Update KronTerm on the remote host before connecting with Desktop SSH.',
    ...
    mcp: {
      ...
      deepLinkDescription:
        'A link asked to add this MCP server to KronTerm. Review the exact configuration below — it comes from the link, not from KronTerm.',
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. KronTerm runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
      ...
      localEndpoint: {
        ...
        description: 'Point KronTerm at any OpenAI-compatible endpoint (Zyphra, vLLM, llama.cpp, Ollama, etc).'
      },
  ...
  starmap: {
    ...
    emptyDesc: 'As KronTerm builds skills and memories for your work, they appear here.',
    share: 'Share map',
    shareHint:
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart KronTerm to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update KronTerm to generate pets.',
      backgroundHint: 'You can close this — KronTerm will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure KronTerm desktop' },
    ...
    hermesActiveSessions: (version, count) => `KronTerm ${version} · Active sessions ${count}`,
  ...
  profiles: {
    ...
    connectGateway: 'Connect another KronTerm gateway…',
    actions: 'Actions',
    color: 'Color…',
    colorFor: 'Color',
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent KronTerm environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    modelImpact: {
      ...
      saveFailed: 'KronTerm did not save that model change.'
    },
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. KronTerm will run it and deliver results to the destination you pick.',
  ...
  sidebar: {
    ...
    projects: {
      ...
      staleBackend:
        'Update the KronTerm backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
      deleteConfirm: 'This removes the saved project from KronTerm. Files, git repos, and worktrees stay untouched.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting KronTerm...',
    placeholderReconnecting: 'Reconnecting to KronTerm…',
    placeholderFollowUp: 'Send follow-up',
    newSessionPlaceholders: [
      'What are we building?',
      'Give KronTerm a task',
      "What's on your mind?",
    ...
    attachUrlDesc: 'KronTerm will fetch the page and include it as context for this turn.',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'Ask KronTerm to open PR',
      agentShipPrompt:
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating KronTerm…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting KronTerm…',
    ...
    unsupportedMessage: 'This version of KronTerm can’t update itself from inside the app.',
    ...
    availableBody: 'A new version of KronTerm is ready to install.',
    availableTitleBackend: 'Backend update available',
    availableBodyBackend: 'A newer version of the connected KronTerm backend is ready to install.',
    availableBodyNoChangelog: 'A newer version is ready. Release notes aren’t available for this install type.',
    updateNow: 'Update now',
    maybeLater: 'Maybe later',
    moreChanges: count => `+ ${count} more change${count === 1 ? '' : 's'} included.`,
    manualTitle: 'Update from your terminal',
    manualBody: 'You installed KronTerm from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'KronTerm will pick up the new version next time you launch it.',
    guiSkewTitle: 'Update the desktop app',
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the KronTerm desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The KronTerm updater takes over in its own window and reopens KronTerm automatically when it’s done. Please don’t reopen KronTerm yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. KronTerm reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then KronTerm reopens on its own.',
    errorTitle: 'Update didn’t finish',
    errorBody: 'No worries — nothing was lost. You can try again now.',
    blockerTitle: 'Close local previews to update KronTerm?',
    blockerBody:
      'KronTerm needs to stop these local previews before updating. This will not modify or delete your files.',
    foreignBlockerTitle: 'Close other processes to update KronTerm',
    foreignBlockerBody:
      'KronTerm can’t safely close these processes automatically. Close the app, terminal, or service that owns each one, then try the update again.',
    mixedBlockerBody:
      'KronTerm can close the local previews listed below. Other processes must be closed manually before the update can continue.',
  ...
  install: {
    ...
    oneTimeTitle: 'KronTerm needs a one-time install',
    ...
    setupChoiceTitle: 'Set up KronTerm Desktop',
    setupChoiceDesc:
      'Connect this app to a KronTerm gateway you already run, or install KronTerm locally on this computer.',
    connectExistingTitle: 'Connect to existing KronTerm',
    ...
    installLocalTitle: 'Install KronTerm locally',
    installLocalDesc: 'Download KronTerm, create its Python environment, and run the backend on this computer.',
    localStartUnavailable: 'Local installation could not start. Restart KronTerm Desktop and try again.',
    remoteSetupTitle: 'Connect to existing KronTerm',
    remoteSetupDesc: 'Enter your gateway URL. KronTerm Desktop will detect whether it needs a token or browser sign-in.',
    remoteUrlTitle: 'Gateway URL',
    remoteUrlDesc: 'Use the base URL of the KronTerm gateway, including https:// when remote.',
    remoteUrlPlaceholder: 'https://gateway.example.com/hermes',
    probing: 'Detecting gateway authentication...',
    probeError: 'Could not reach that KronTerm gateway.',
    identityProvider: 'your identity provider',
    authTitle: 'Authentication',
    ...
    settingUpTitle: 'Setting up KronTerm Agent',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another KronTerm CLI or desktop instance is running. Stop any running KronTerm instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
      'This is a one-time setup. The KronTerm installer is downloading dependencies and configuring your machine. Subsequent launches will skip this step.',
  ...
  onboarding: {
    headerTitle: "Let's get you setup with KronTerm Agent",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'KronTerm is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting KronTerm…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run KronTerm',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point KronTerm at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — KronTerm connects automatically',
    ...
    authorizeThere: 'Authorize KronTerm there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize KronTerm there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      desktopVersion: version => `KronTerm Desktop v${version}`,
      backendVersion: version => `Backend v${version}`,
      clientLabel: version => `client v${version}`,
      connectionSsh: host => `SSH: ${host}`,
      connectionRemote: host => `Remote: ${host}`,
      connectionCloud: host => `Cloud: ${host}`,
      connectionCloudTooltip: host => `KronTerm Cloud · ${host}`,
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. KronTerm will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'KronTerm is restarting...',
      askRestart: 'Ask KronTerm to restart the server',
      lookingRestart: taskId => `KronTerm is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'KronTerm is working in the background. Watch the preview console for progress.',
      ...
      finishedRestarting: message => `KronTerm finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'KronTerm could not restart the server.',
      stillWorking:
        'KronTerm is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'KronTerm is loading a response',
    ...
    approval: {
      gatewayDisconnected: 'KronTerm gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.hermes/config.yaml). KronTerm won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'KronTerm needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'KronTerm needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart KronTerm Desktop to use Save Image.',
    restartToSaveImages: 'Restart KronTerm Desktop to save images',
