...
export const en: Translations = {
    ...
    boot: {
        ...
        steps: {
            ...
            startingHermesDesktop: "Starting Kronos…",
        },
        errors: {
    ...
    settings: {
        ...
        plugins: {
            ...
            agent: {
                title: "Agent plugins",
                blurb: "Run in the KronTerm backend — tools, skills, MCP servers, hooks, and slash commands. Portable ones are Agent Plugins packages (skills + MCP bundles that work in other agents too). Toggles apply to new sessions.",
        ...
        appearance: {
            ...
            pet: {
                title: "Pet",
                intro: "Adopt an animated petdex mascot that floats over the app and reacts to what KronTerm is doing — running while tools execute, celebrating on success, sulking on errors.",
                restartHint:
        ...
        connections: {
            title: "Connections",
            intro: "Register every place your agents live — this device, remote gateways on your network, and KronTerm Cloud instances. All of them are stored here.",
            stagedNote:
        ...
        gateway: {
            ...
            intro: "Local by default. Use remote when this app should drive a KronTerm backend elsewhere. Per-profile overrides below.",
        ...
        providers: {
            ...
            intro: "Sign in with a subscription — no API key to copy. KronTerm runs the browser sign-in for you, right here in the app.",
            connected: "Connected",
            collapse: "Collapse",
    ...
    sidebar: {
        ...
        projects: {
            ...
            deleteConfirm:
                "This removes the saved project from KronTerm. Files, git repos, and worktrees stay untouched.",
    ...
    updates: {
        ...
        manualBody:
            "You installed KronTerm from the command line, so updates run there too. Paste this into your terminal:",
    ...
    install: {
        ...
        remoteSetupDesc:
            "Enter your gateway URL. KronTerm Desktop will detect whether it needs a token or browser sign-in.",
    ...
    onboarding: {
        ...
        apiKeyOptions: {
            ...
            local: {
                short: "self-hosted",
                description:
                    "Point KronTerm at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).",
            },
        },
    ...
    preview: {
        ...
        web: {
            ...
            finishedRestarting: (message) =>
                `KronTerm finished restarting the preview server${message ? `: ${message}` : ""}`,
