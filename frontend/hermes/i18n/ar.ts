...
export const ar = defineLocale({
    ...
    boot: {
        ready: "KronTerm Desktop جاهز",
        desktopBootFailedWithMessage: (message) => `فشل تشغيل سطح المكتب: ${message}`,
        steps: {
            connectingGateway: "جار الاتصال ببوابة سطح المكتب",
            loadingSettings: "جار تحميل إعدادات KronTerm",
            loadingSessions: "جار تحميل الجلسات الأخيرة",
            startingDesktopConnection: "جار بدء اتصال سطح المكتب",
            startingHermesDesktop: "جار تشغيل Kronos...",
        },
        errors: {
            backgroundExited: "خرجت عملية KronTerm الخلفية.",
            backgroundExitedDuringStartup: "خرجت عملية KronTerm الخلفية أثناء بدء التشغيل.",
    ...
    notifications: {
        ...
        backendOutOfDateMessage: "خلفية KronTerm أقدم من إصدار سطح المكتب الحالي وقد لا تعمل كما يجب. حدثهما ليتوافقا.",
        updateHermes: "تحديث Kronos",
        ...
        errors: {
            ...
            methodNotAllowed:
                "رفضت خلفية سطح المكتب هذا الطلب (405 Method Not Allowed). جرب إعادة تشغيل KronTerm Desktop.",
        ...
        native: {
            ...
            inputBody: "ينتظر KronTerm ردّك.",
            turnDoneTitle: "أنهى KronTerm",
            turnDoneBody: "",
    ...
    settings: {
        ...
        resetConfirm: "هل تريد إعادة كل الإعدادات إلى افتراضيات KronTerm؟",
        ...
        plugins: {
            ...
            blurb: "امتدادات واجهة تُحمّل داخل هذا التطبيق — إما مضمّنة مع البناء، أو موضوعة في مجلد desktop-plugins (بما فيها التي يكتبها KronTerm). تعطيل الإضافة يفرغها مباشرة ويبقى بعد إعادة التشغيل.",
            count: (n) => `${n} مثبتة`,
        ...
        notifications: {
            title: "الإشعارات",
            intro: "إشعارات سطح المكتب الأصلية، منفصلة عن التنبيهات داخل التطبيق. هذه محلية على الجهاز — كل حاسوب يحتفظ بإعداداته الخاصة.",
            enableAll: "تفعيل الإشعارات",
            enableAllDesc: "إيقافه يصمت كل الإشعارات أدناه.",
            focusedHint: "تنبيهات الاكتمال تظهر فقط عندما يكون KronTerm في الخلفية.",
            kinds: {
                approval: {
                    label: "يلزم الموافقة",
                ...
                input: {
                    label: "يلزم إدخال",
                    description: "طرح KronTerm سؤالا أو يحتاج إلى كلمة مرور أو سر.",
                },
                turnDone: {
                    label: "الرد جاهز",
                    description: "انتهى دور بينما كان KronTerm في الخلفية.",
                },
                turnError: {
                    label: "فشل الدور",
        ...
        appearance: {
            title: "المظهر",
            intro: "خصص مظهر KronTerm Desktop.",
            ...
            backdropDesc: "اختيار مقدار مزج خلفية سطح المكتب مع سطح KronTerm.",
            reactionsTitle: "تفاعلات الرسائل",
            reactionsDesc: "تفاعلات إيموجي بأسلوب iMessage — تفاعل مع الرسائل، ويمكن لـ KronTerm التفاعل مع رسائلك.",
            ...
            pet: {
                title: "حيوان أليف",
                intro: "تبنَّ تعويذة petdex متحركة تطفو فوق التطبيق وتتفاعل مع ما يفعله KronTerm — تجري أثناء تنفيذ الأدوات، وتحتفل عند النجاح، وتعبس عند الأخطاء.",
                restartHint:
                    "تحتاج الحيوانات الأليفة إلى إعادة تشغيل سريعة — بدأ التطبيق العامل قبل إضافة هذه الميزة. أغلق KronTerm وأعد فتحه، ثم ارجع إلى هنا.",
                on: "تشغيل",
                off: "إيقاف",
                scaleTitle: "الحجم",
        ...
        fieldDescriptions: {
            ...
            timezone: "تستخدم عندما يحتاج KronTerm إلى سياق الوقت المحلي. اتركها فارغة لاستخدام منطقة النظام.",
            "agent.imageInputMode": "يتحكم في طريقة إرسال مرفقات الصور إلى النموذج.",
            "agent.maxTurns": "الحد الأعلى لدورات استدعاء الأدوات قبل أن يوقف KronTerm التشغيل.",
            ...
            fileReadMaxChars: "أقصى عدد أحرف يستطيع KronTerm قراءته من ملف واحد في الطلب.",
            "approvals.mode": "كيف يتعامل KronTerm مع الأوامر التي تحتاج موافقة صريحة.",
            ...
            "updates.nonInteractiveLocalChanges":
                "عندما يحدّث KronTerm نفسه من التطبيق دون موجه طرفية، احتفظ بتعديلات المصدر المحلية أو تجاهلها.",
        },
        about: {
            heading: "حول KronTerm",
            ...
            automaticUpdatesDesc: "اسمح لـ KronTerm بالتحقق من التحديثات وتثبيتها.",
        ...
        config: {
            ...
            loading: "جار تحميل إعدادات KronTerm...",
        ...
        quickEntry: {
            ...
            enabledDesc: "استدعِ محرّرا صغيرا من أي مكان باختصار عام وأرسل طلبا دون فتح KronTerm.",
        ...
        gateway: {
            ...
            intro: "يشغّل KronTerm Desktop بوابة محلية خاصة افتراضياً. استخدم بوابة بعيدة عندما تريد أن يتحكم هذا التطبيق بخلفية KronTerm تعمل مسبقاً على جهاز آخر أو خلف وكيل موثوق.",
            appliesTo: "ينطبق على",
            ...
            localDesc: "تشغيل خلفية KronTerm خاصة على localhost. هذا هو الافتراضي ويعمل دون اتصال.",
            ...
            remoteDesc:
                "صل واجهة سطح المكتب هذه بخلفية KronTerm بعيدة. البوابات المستضافة تستخدم OAuth أو اسم مستخدم وكلمة مرور، والبوابات الذاتية قد تستخدم رمز جلسة.",
            ...
            restartingMessage: "سيعيد KronTerm Desktop الاتصال باستخدام الإعدادات المحفوظة.",
            savedMessage: "تم الحفظ للتشغيل القادم.",
            connectedTo: (baseUrl, version) => `متصل بـ ${baseUrl}${version ? ` · KronTerm ${version}` : ""}`,
        ...
        mcp: {
            ...
            deepLinkDescription:
                "طلب رابط إضافة خادم MCP هذا إلى KronTerm. راجع الإعدادات الكاملة أدناه — فهي قادمة من الرابط وليست من KronTerm.",
        ...
        providers: {
            ...
            intro: "سجل الدخول باشتراكك دون نسخ مفتاح API. يشغّل KronTerm تسجيل الدخول من المتصفح لك داخل التطبيق.",
            connected: "متصل",
            collapse: "طي",
    ...
    commandCenter: {
        ...
        pets: {
            ...
            staleBackend: "أعد تشغيل KronTerm لاستخدام الحيوانات الأليفة — الخادم الخلفي أقدم من هذه الميزة.",
        ...
        generatePet: {
            ...
            staleBackend: "حدّث KronTerm لتوليد الحيوانات الأليفة.",
            backgroundHint: "يمكنك إغلاق هذا — سيُعلِمك KronTerm عند الانتهاء.",
        ...
        hermesActiveSessions: (version, count) => `KronTerm ${version} لديه ${count} جلسة نشطة`,
    ...
    cron: {
        ...
        modelImpact: {
            ...
            saveFailed: "لم يحفظ KronTerm تغيير النموذج هذا.",
        },
        search: "بحث",
        loading: "جار التحميل...",
        states: {
        ...
        emptyDescNew: "أنشئ مهمة مجدولة لتشغيل KronTerm تلقائيا.",
        ...
        createDesc: "اضبط مهمة يشغلها KronTerm تلقائيا.",
        nameLabel: "الاسم",
        namePlaceholder: "مثال: الملخص الصباحي",
        promptLabel: "الرسالة",
        promptPlaceholder: "ماذا تريد من KronTerm أن يفعل؟",
    ...
    sidebar: {
        ...
        projects: {
            ...
            deleteConfirm: "هذا يزيل المشروع المحفوظ من KronTerm. تبقى الملفات ومستودعات git وأشجار العمل دون تغيير.",
    ...
    composer: {
        ...
        placeholderStarting: "جار بدء KronTerm...",
        placeholderReconnecting: "جار إعادة الاتصال...",
        placeholderFollowUp: "اكتب متابعة...",
        newSessionPlaceholders: ["اسأل KronTerm عن شيء...", "اطلب من KronTerm تنفيذ مهمة...", "ابدأ محادثة جديدة..."],
        ...
        urlHintPre: "سيقرأ KronTerm الرابط ضمن السياق.",
        attach: "إرفاق",
    ...
    statusStack: {
        ...
        coding: {
            ...
            agentShip: "اطلب من KronTerm فتح PR",
    ...
    updates: {
        stages: {
            ...
            pydeps: "جار الإنهاء...",
            update: "جار تحديث KronTerm...",
            rebuild: "جار إعادة بناء تطبيق سطح المكتب...",
            restart: "جار إعادة تشغيل KronTerm...",
            done: "اكتمل التحديث",
        ...
        unsupportedMessage: "لا يمكن لهذا الإصدار من KronTerm تحديث نفسه من داخل التطبيق.",
        ...
        availableBody: "إصدار جديد من KronTerm جاهز للتثبيت.",
        availableTitleBackend: "يتوفر تحديث للواجهة الخلفية",
        availableBodyBackend: "إصدار أحدث من واجهة KronTerm الخلفية المتصلة جاهز للتثبيت.",
        ...
        manualBody: "لقد ثبّتت KronTerm من سطر الأوامر، لذا تُجرى التحديثات من هناك أيضا. الصق هذا في طرفيتك:",
        manualPickedUp: "سيلتقط KronTerm الإصدار الجديد في المرة التالية التي تشغّله فيها.",
        guiSkewTitle: "تحديث تطبيق سطح المكتب",
        guiSkewBody:
            "تم تحديث الواجهة الخلفية، لكن حزمة تطبيق سطح المكتب هذه لم تتغير. حدّث أو أعد تثبيت تطبيق KronTerm لسطح المكتب (ملف AppImage / ‎.deb / ‎.rpm) لمطابقته.",
        copy: "نسخ",
        copied: "تم النسخ",
        done: "تم",
        applyingBody:
            "يتولّى مُحدِّث KronTerm المهمة في نافذته الخاصة ويعيد فتح KronTerm تلقائيا عند الانتهاء. الرجاء عدم إعادة فتح KronTerm بنفسك أثناء التحديث.",
        applyingBodyBackend:
            "تطبّق الواجهة الخلفية البعيدة التحديث وستعيد التشغيل. يعيد KronTerm الاتصال تلقائيا عند عودتها.",
        applyingClose: "ستُغلق هذه النافذة أثناء تشغيل التحديث، ثم يعيد KronTerm فتح نفسه تلقائيا.",
        errorTitle: "لم يكتمل التحديث",
        errorBody: "لا داعي للقلق — لم يُفقد شيء. يمكنك إعادة المحاولة الآن.",
        blockerTitle: "إغلاق المعاينات المحلية لتحديث KronTerm؟",
        blockerBody:
            "يحتاج KronTerm إلى إيقاف هذه المعاينات المحلية قبل التحديث. لن يؤدي ذلك إلى تعديل ملفاتك أو حذفها.",
        foreignBlockerTitle: "أغلق العمليات الأخرى لتحديث KronTerm",
        foreignBlockerBody:
            "لا يمكن لـ KronTerm إغلاق هذه العمليات تلقائيًا بأمان. أغلق التطبيق أو الطرفية أو الخدمة التي تشغّل كل عملية، ثم حاول التحديث مرة أخرى.",
        mixedBlockerBody:
            "يمكن لـ KronTerm إغلاق المعاينات المحلية المدرجة أدناه. يجب إغلاق العمليات الأخرى يدويًا قبل متابعة التحديث.",
    ...
    install: {
        ...
        oneTimeTitle: "يحتاج KronTerm إلى تثبيت لمرة واحدة",
        ...
        settingUpTitle: "جار إعداد وكيل KronTerm",
        finishingTitle: "جار الإنهاء",
        failedDesc:
            "فشلت إحدى خطوات التثبيت. على Windows، قد يحدث هذا إذا كان هناك نسخة أخرى من KronTerm CLI أو تطبيق سطح المكتب قيد التشغيل. أوقف أي نسخ KronTerm قيد التشغيل، ثم أعد المحاولة. تحقق من التفاصيل أدناه أو من سجل سطح المكتب للحصول على النص الكامل.",
        activeDesc:
            "هذا إعداد لمرة واحدة. يقوم مثبّت KronTerm بتنزيل التبعيات وتهيئة جهازك. ستتخطى عمليات التشغيل اللاحقة هذه الخطوة.",
    ...
    onboarding: {
        headerTitle: "لنُعِدّ لك KronTerm Agent",
        headerDesc: "اربط مزوّد نماذج لبدء المحادثة. معظم الخيارات تتطلب نقرة واحدة.",
        preparingInstall: "يُكمل KronTerm التثبيت. عادة ما يستغرق ذلك أقل من دقيقة في أول تشغيل.",
        starting: "جار بدء KronTerm...",
        ...
        recommended: "موصى به",
        connected: "متصل",
        featuredPitch: "اشتراك واحد، أكثر من 300 نموذج متقدم — الطريقة الموصى بها لتشغيل KronTerm",
        ...
        apiKeyOptions: {
            ...
            local: {
                short: "مستضاف ذاتيا",
                description:
                    "وجّه KronTerm إلى نقطة نهاية محلية أو مستضافة ذاتيا متوافقة مع OpenAI (vLLM، llama.cpp، Ollama، إلخ).",
            },
        },
        ...
        flowSubtitles: {
            ...
            device_code: "يفتح صفحة تحقق في المتصفح — يتصل KronTerm تلقائياً",
            loopback: "يفتح المتصفح لتسجيل الدخول — يتصل KronTerm تلقائياً",
        ...
        authorizeThere: "صرّح لـ KronTerm هناك.",
        copyAuthCode: "انسخ رمز التفويض وألصقه أدناه.",
        pasteAuthCode: "ألصق رمز التفويض",
        reopenAuthPage: "إعادة فتح صفحة التفويض",
        autoBrowser: (provider) =>
            `فتحنا ${provider} في المتصفح. صرّح لـ KronTerm هناك وسيتم الاتصال تلقائياً دون نسخ أو لصق.`,
    ...
    preview: {
        ...
        largeBody: (label, size) => `حجم ${label} هو ${size}. سيعرض KronTerm أول 512 KB فقط.`,
        ...
        web: {
            ...
            tryAgain: "إعادة المحاولة",
            restarting: "جار إعادة تشغيل KronTerm...",
            askRestart: "اطلب من KronTerm إعادة تشغيل الخادم",
            lookingRestart: (taskId) => `يبحث KronTerm عن خادم معاينة لإعادة تشغيله (${taskId})`,
            restartingTitle: "جار إعادة تشغيل خادم المعاينة",
            restartingMessage: "يعمل KronTerm في الخلفية. راقب كونسول المعاينة لمتابعة التقدم.",
            ...
            finishedRestarting: (message) => `أنهى KronTerm إعادة تشغيل خادم المعاينة${message ? `: ${message}` : ""}`,
            ...
            restartFailedMessage: "تعذّر على KronTerm إعادة تشغيل الخادم.",
            stillWorking:
                "لا يزال KronTerm يعمل، لكن لم تصل نتيجة إعادة التشغيل بعد. قد يكون أمر الخادم قيد التشغيل في المقدمة.",
