...
export const ja = defineLocale({
    ...
    boot: {
        ...
        steps: {
            ...
            startingHermesDesktop: "Kronos を起動中…",
        },
        errors: {
    ...
    settings: {
        ...
        appearance: {
            ...
            pet: {
                title: "ペット",
                intro: "アプリ上に浮かぶ petdex のアニメーションマスコットを採用しましょう。ツール実行中は走り、成功すると喜び、エラーでしょんぼりと、KronTerm の状態に反応します。",
                restartHint:
        ...
        gateway: {
            ...
            intro: "KronTerm Desktop はデフォルトで独自のローカルゲートウェイを起動します。別のマシンや信頼できるプロキシの背後で既に動作している KronTerm バックエンドをこのアプリで制御する場合は、リモートゲートウェイを使用してください。以下でプロファイルを選択して、それぞれのリモートホストを設定します。",
            appliesTo: "適用対象",
        ...
        providers: {
            ...
            intro: "サブスクリプションでサインインします。API キーのコピーは不要です。KronTerm がアプリ内でブラウザーサインインを代行します。",
            connected: "接続済み",
            collapse: "折りたたむ",
    ...
    updates: {
        ...
        applyingBodyBackend:
            "リモートバックエンドが更新を適用して再起動します。復帰すると KronTerm が自動的に再接続します。",
    ...
    install: {
        ...
        installLocalDesc:
            "KronTerm をダウンロードし、Python 環境を作成して、このコンピューターでバックエンドを実行します。",
    ...
    preview: {
        ...
        web: {
            ...
            restartingMessage:
                "KronTerm はバックグラウンドで作業中です。進捗はプレビューコンソールで確認してください。",
