...
import type { CommandCenterSection } from '@hermes/app/command-center'
import { useApprovalModeStatusbarItem } from '@hermes/app/shell/approval-mode-menu'
import { ContextUsagePanel } from '@hermes/app/shell/context-usage-panel'
import { GatewayMenuPanel } from '@hermes/app/shell/gateway-menu-panel'
import { useContextBreakdown } from '@hermes/app/shell/hooks/use-context-breakdown'
import { $paneVisible, togglePaneVisible } from '@hermes/components/pane-shell/tree/store'
...
import { copyFilePath, revealFile } from '@hermes/store/file-actions'
import { revealFileInTree } from '@hermes/store/layout'
import { $activeGatewayProfile } from '@hermes/store/profile'
import { $projectTree, projectNameForCwd } from '@hermes/store/projects'
import {
  $activeSessionId,
  $busy,
  $connection,
...
import { $focusedRuntimeId, $focusedSessionState, $focusedStoredSessionId } from '@hermes/store/session-states'
import { $statusbarHiddenIds } from '@hermes/store/statusbar-prefs'
import { $subagentsBySession, activeSubagentCount, failedSubagentCount } from '@hermes/store/subagents'
import { $gatewayRestarting } from '@hermes/store/system-actions'
import {
  $backendUpdateApply,
  $backendUpdateStatus,
  $desktopVersion,
...
import type { StatusResponse, UsageStats } from '@hermes/types/hermes'
