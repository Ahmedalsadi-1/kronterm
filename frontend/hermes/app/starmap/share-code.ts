import { type BitReader, type BitWriter, createLoadout, Dict, idxOf, indexBits, LoadoutError } from '@hermes/lib/loadout'
import type { StarmapEdge, StarmapGraph, StarmapNode } from '@hermes/types/hermes'
...
const VERSION = 3
const PREFIX = 'HML' // "KronTerm Memory Loadout" — namespaces our codes like WoW's leading bytes.
