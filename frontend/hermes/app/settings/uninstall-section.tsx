...
import type { DesktopUninstallMode, DesktopUninstallSummary } from '@hermes/global'
import { AlertTriangle, Loader2, Trash2 } from '@hermes/lib/icons'
...
const OPTIONS: ModeOption[] = [
  {
    ...
    description: 'Remove this desktop app. The KronTerm agent, your config, and chats all stay.',
  ...
  },
  {
    ...
    description: 'Remove the app and the KronTerm agent, but keep config, chats, and secrets for a future reinstall.',
    consequence: 'the Chat GUI and the KronTerm agent (config, chats, and secrets are kept)',
    needsAgent: true
  },
  {
    mode: 'full',
    ...
    consequence: 'EVERYTHING — the Chat GUI, the KronTerm agent, and all of your config, chats, secrets, and logs',
