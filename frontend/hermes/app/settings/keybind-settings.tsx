...
import { Kbd, KbdCombo } from '@hermes/components/ui/kbd'
...
import {
  ...
  KEYBINDS_AREA
} from '@hermes/lib/keybinds/actions'
import { formatCombo } from '@hermes/lib/keybinds/combo'
import { arraysEqual } from '@hermes/lib/storage'
import {
  $bindings,
  $capture,
  beginCapture,
