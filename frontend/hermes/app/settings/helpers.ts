import { asText, normalize } from '@hermes/lib/text'
import type { ConfigFieldSchema, HermesConfigRecord, ToolsetInfo } from '@hermes/types/hermes'
...
export { asText, includesQuery, prettyName } from '@hermes/lib/text'
