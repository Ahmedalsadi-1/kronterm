...
import { $pluginRecords, type PluginRecord, setPluginEnabled } from '@hermes/contrib/plugins-store'
...
import { FolderOpen, Monitor, Package, RefreshCw } from '@hermes/lib/icons'
...
import {
  ...
  loadAgentPlugins,
  toggleAgentPlugin
} from '@hermes/store/agent-plugins'
import { notifyError } from '@hermes/store/notifications'
import { $connection, $gatewayState } from '@hermes/store/session'
