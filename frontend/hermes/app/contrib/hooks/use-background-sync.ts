...
import { preserveLocalAssistantErrors, sealOpenToolParts, toChatMessages } from '@hermes/lib/chat-messages'
import { createClientSessionState } from '@hermes/lib/chat-runtime'
import { sessionMessagesSignature } from '@hermes/lib/session-signatures'
import { $changeEventsAvailable, $cronChangeTick, $sessionsChangeTick } from '@hermes/store/live-sync'
import { $onBattery, batteryPollInterval } from '@hermes/store/power'
import { refreshActiveProfile } from '@hermes/store/profile'
import {
  $activeSessionId,
  $busy,
  $currentCwd,
