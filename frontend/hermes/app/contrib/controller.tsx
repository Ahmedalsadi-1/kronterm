...
import { SessionDraftTitle } from '@hermes/app/chat/session-draft-title'
import { SessionStatusDot } from '@hermes/app/chat/session-status-dot'
import { PALETTE_AREA, type PaletteContribution, paletteToggle } from '@hermes/app/command-palette/contrib'
import { type StatusbarItem } from '@hermes/app/shell/statusbar-controls'
import { IdleMount } from '@hermes/components/idle-mount'
import { $layoutEditMode, toggleLayoutEditMode } from '@hermes/components/pane-shell/edit-mode'
import { allPaneIds, group, groupLeafIds, split } from '@hermes/components/pane-shell/tree/model'
import { LayoutTreeRoot } from '@hermes/components/pane-shell/tree/renderer'
import type { DoubleTapContext } from '@hermes/components/pane-shell/tree/renderer/drag-session'
import {
  $layoutTree,
  bindPaneVisibility,
...
} from '@hermes/components/pane-shell/tree/store'
import { SidebarProvider } from '@hermes/components/ui/sidebar'
import { discoverBundledPlugins } from '@hermes/contrib/plugins'
import { Slot } from '@hermes/contrib/react/slot'
import { useContributions } from '@hermes/contrib/react/use-contributions'
import { registry } from '@hermes/contrib/registry'
import { discoverRuntimePlugins } from '@hermes/contrib/runtime-loader'
...
import {
  ...
  SIDEBAR_MAX_WIDTH
} from '@hermes/store/layout'
import { runExportProfileFlow, runImportProfileFlow } from '@hermes/store/profile-share'
import { $reviewOpen, closeReview, openReview, REVIEW_PANE_ID } from '@hermes/store/review'
import { $currentCwd, $selectedStoredSessionId, $sessions, $yoloActive, sessionMatchesStoredId } from '@hermes/store/session'
import { watchSessionPins } from '@hermes/store/session-pin-sync'
import { watchUnreadWriteGuard } from '@hermes/store/session-unread-remote'
import { $statusbarVisible } from '@hermes/store/statusbar-prefs'
import { isHudWindow } from '@hermes/store/windows'
