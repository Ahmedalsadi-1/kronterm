...
import { PALETTE_AREA, type PaletteContribution } from '@hermes/app/command-palette/contrib'
import { registry } from '@hermes/contrib/registry'
import { CreditCard } from '@hermes/lib/icons'
import { emitLocalGatewayEvent } from '@hermes/store/gateway'
