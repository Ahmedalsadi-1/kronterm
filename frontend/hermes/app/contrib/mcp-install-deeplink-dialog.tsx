...
import { getHermesConfigRecord, saveMcpServers } from '@hermes/hermes'
import { useI18n } from '@hermes/i18n'
import { AlertTriangle } from '@hermes/lib/icons'
import { MCP_DEEPLINK_NAME_RE } from '@hermes/lib/mcp-deeplink'
import { $mcpInstallRequest } from '@hermes/store/mcp-deeplink-install'
import { notify, readableError } from '@hermes/store/notifications'
