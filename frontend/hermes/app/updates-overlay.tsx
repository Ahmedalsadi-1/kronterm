...
import { BrandMark } from '@hermes/components/brand-mark'
import { Button } from '@hermes/components/ui/button'
import { writeClipboardText } from '@hermes/components/ui/copy-button'
import {
  Dialog,
  DialogContent,
  DialogDescription,
...
import { ErrorIcon, ErrorState } from '@hermes/components/ui/error-state'
import { Loader } from '@hermes/components/ui/loader'
import { Progress } from '@hermes/components/ui/progress'
import type { DesktopUpdateBlocker, DesktopUpdateCommit, DesktopUpdateStage, DesktopUpdateStatus } from '@hermes/global'
import { useI18n } from '@hermes/i18n'
import { buildCommitChangelog, type CommitGroup } from '@hermes/lib/commit-changelog'
import { AlertCircle, Check, Copy, Terminal } from '@hermes/lib/icons'
import { resolveUpdateCopy, type UpdateTarget } from '@hermes/lib/update-copy'
