...
import { reloadPersistedDrafts, requestComposerDraftSync } from "@hermes/store/composer";
import { reportHudSession, watchHudState } from "@hermes/store/hud";
import { $selectedStoredSessionId } from "@hermes/store/session";
import { focusOpenSession, sessionTileDelegate } from "@hermes/store/session-states";
...
export function useReportHudSession(): void {
    ...
    }, [hudMode, selectedStoredSessionId]);
}
