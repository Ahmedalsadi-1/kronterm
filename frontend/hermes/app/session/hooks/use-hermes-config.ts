...
import { setTerminalFontFamilyFromConfig } from '@hermes/app/right-sidebar/terminal/terminal-font'
import { getHermesConfig, getHermesConfigDefaults } from '@hermes/hermes'
import { BUILTIN_PERSONALITIES, normalizePersonalityValue, personalityNamesFromConfig } from '@hermes/lib/chat-runtime'
import { normalize } from '@hermes/lib/text'
import { setDisplayTimestampsFromConfig } from '@hermes/store/display-timestamps'
import {
