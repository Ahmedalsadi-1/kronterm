...
import { getProfiles } from '@hermes/hermes'
import type { Translations } from '@hermes/i18n'
import { type ChatMessage, toChatMessages } from '@hermes/lib/chat-messages'
import { parseCommandDispatch, parseSlashCommand, sessionTitle } from '@hermes/lib/chat-runtime'
import {
...
} from '@hermes/lib/desktop-slash-commands'
import { isMissingRpcMethod } from '@hermes/lib/gateway-rpc'
import { setSessionYolo } from '@hermes/lib/yolo-session'
import { openCommandPalettePage } from '@hermes/store/command-palette'
import { setComposerDraft } from '@hermes/store/composer'
import { enqueueQueuedPrompt } from '@hermes/store/composer-queue'
import { applyGoalStatusText } from '@hermes/store/goals'
import { dismissNotification, notify, notifyError } from '@hermes/store/notifications'
import { setPetScale } from '@hermes/store/pet-gallery'
import { $petGenInput, openPetGenerate } from '@hermes/store/pet-generate'
