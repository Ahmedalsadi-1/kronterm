...
import { ArchiveSkillConfirmDialog } from '@hermes/app/learning/archive-skill-confirm-dialog'
import { CodeEditor } from '@hermes/components/chat/code-editor'
import { PageLoader } from '@hermes/components/page-loader'
import { Badge } from '@hermes/components/ui/badge'
...
import { CountSkeleton } from '@hermes/components/ui/skeleton'
import {
  editLearningNode,
  getLearningNode,
  getProfiles,
...
import { isDesktopToolsetVisible } from '@hermes/lib/desktop-toolsets'
...
import type { SkillInfo, ToolsetInfo } from '@hermes/types/hermes'
          ...
          <SelectContent>
            {profiles.map(p => (
              <SelectItem key={p.name} value={p.name}>
                {p.is_default ? 'KronTerm (default)' : p.name}
              </SelectItem>
            ))}
          </SelectContent>
        </Select>
