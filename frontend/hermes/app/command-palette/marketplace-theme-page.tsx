...
import { HUD_ITEM, HUD_TEXT } from '@hermes/app/floating-hud'
...
import { Check, Download, Loader2, Palette } from '@hermes/lib/icons'
import { cn } from '@hermes/lib/utils'
import { installVscodeThemeFromMarketplace } from '@hermes/themes/install'
import { $marketplaceInstalls } from '@hermes/themes/user-themes'
