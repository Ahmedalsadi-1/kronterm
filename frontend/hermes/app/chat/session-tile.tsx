...
import { useModelControls } from '@hermes/app/session/hooks/use-model-controls'
import { blobToDataUrl } from '@hermes/app/session/hooks/use-prompt-actions/utils'
import { resolveStoredSession } from '@hermes/app/session/hooks/use-session-actions/utils'
import { ModelMenuPanel } from '@hermes/app/shell/model-menu-panel'
import { formatRefValue } from '@hermes/components/assistant-ui/directive-text'
import { CenteredThreadSpinner } from '@hermes/components/assistant-ui/thread/status'
import { findGroupOfPane } from '@hermes/components/pane-shell/tree/model'
import { $layoutTree, closeTreePane, moveTreePane, setTreeGroupHeaderHidden } from '@hermes/components/pane-shell/tree/store'
import { Button } from '@hermes/components/ui/button'
import { ConfirmDialog } from '@hermes/components/ui/confirm-dialog'
import { transcribeAudio } from '@hermes/hermes'
import { useI18n } from '@hermes/i18n'
import type { ChatMessage } from '@hermes/lib/chat-messages'
import { NEW_SESSION_TITLE, sessionTitle } from '@hermes/lib/chat-runtime'
import { createComposerAttachmentScope, draftTitleFor } from '@hermes/store/composer'
import { $pinnedSessionIds, pinSession, unpinSession } from '@hermes/store/layout'
import { $activeGatewayProfile } from '@hermes/store/profile'
import { $projectTree } from '@hermes/store/projects'
import { sessionAwaitingInput } from '@hermes/store/prompts'
import {
  $gatewayState,
