...
import { composerFloatingPill } from '@hermes/components/chat/composer-dock'
...
import { $composerSuggestionsBySession, markSuggestionInvoked, suggestionKey } from '@hermes/store/composer-suggestions'
