...
import { ModelMenuCloseContext } from '@hermes/app/shell/model-menu-panel'
import { Button } from '@hermes/components/ui/button'
import { DropdownMenu, DropdownMenuContent, DropdownMenuTrigger } from '@hermes/components/ui/dropdown-menu'
import { GlyphSpinner } from '@hermes/components/ui/glyph-spinner'
import { releaseTypingFocus } from '@hermes/components/ui/keyboard-first'
import { Tip } from '@hermes/components/ui/tooltip'
import { useI18n } from '@hermes/i18n'
import { ChevronDown } from '@hermes/lib/icons'
import { formatModelStatusLabel } from '@hermes/lib/model-status-label'
import { cn } from '@hermes/lib/utils'
import { $currentModelSource, $defaultReasoningEffort, setModelPickerOpen } from '@hermes/store/session'
