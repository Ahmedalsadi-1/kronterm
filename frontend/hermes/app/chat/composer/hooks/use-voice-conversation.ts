...
import { startThinkingSound, stopThinkingSound } from '@hermes/lib/thinking-sound'
import { monitorSpeechDuringPlayback } from '@hermes/lib/voice-barge-in'
import {
...
import { isVoiceStopCommand } from '@hermes/lib/voice-stop-word'
