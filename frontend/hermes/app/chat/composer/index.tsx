...
import { useHudComposerDrag } from '@hermes/app/hud/composer-drag'
import { composerFill, composerFloatingStrip, composerSurfaceGlass } from '@hermes/components/chat/composer-dock'
import { Button } from '@hermes/components/ui/button'
import { Slot as ContribSlot } from '@hermes/contrib/react/slot'
import { useI18n } from '@hermes/i18n'
import { chatMessageText } from '@hermes/lib/chat-messages'
import { PR_COMMENT_URL_RE } from '@hermes/lib/chat-runtime'
...
import { interceptsTypedVoiceStop } from '@hermes/lib/voice-stop-word'
import { sessionCompacting } from '@hermes/store/compaction'
import { browseBackward, browseForward, deriveUserHistory, isBrowsingHistory } from '@hermes/store/composer-input-history'
import { POPOUT_WIDTH_REM } from '@hermes/store/composer-popout'
import { parkQueuedPrompts, removeQueuedPrompt, unparkQueuedPrompts } from '@hermes/store/composer-queue'
import { $hudMode } from '@hermes/store/hud'
import { sessionBlockingPrompt } from '@hermes/store/prompts'
import { toggleReview } from '@hermes/store/review'
import { $gatewayState } from '@hermes/store/session'
import { $threadScrolledUp } from '@hermes/store/thread-scroll'
import { $autoSpeakReplies } from '@hermes/store/voice-prefs'
import { useTheme } from '@hermes/themes'
