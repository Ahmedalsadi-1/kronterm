...
import { queryAllVisible, queryVisible } from '@hermes/components/pane-shell/pane-visibility'
import { $hoveredTreeGroup } from '@hermes/components/pane-shell/tree/store'
