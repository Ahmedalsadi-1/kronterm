import { mainChatOccupied } from '@hermes/app/open-session'
import { closeActiveTerminal } from '@hermes/app/right-sidebar/terminal/terminals'
import { $workspaceIsPage } from '@hermes/app/routes'
import { closeFocusedSessionTab, closeFocusedToolTab } from '@hermes/components/pane-shell/tree/store'
import { isFocusWithin } from '@hermes/lib/keybinds/combo'
import { requestFreshSession } from '@hermes/store/profile'
import { $activeSessionId, $selectedStoredSessionId } from '@hermes/store/session'
import { closeSessionTile, nextSessionTileForWorkspace } from '@hermes/store/session-states'
