...
import { registerPaneCloser, removeTreePane, treePanesWithPrefix } from '@hermes/components/pane-shell/tree/store'
import type { PaneStripTool } from '@hermes/components/ui/pane-tab'
import { registry } from '@hermes/contrib/registry'
import type { TileDock } from '@hermes/store/session-states'
