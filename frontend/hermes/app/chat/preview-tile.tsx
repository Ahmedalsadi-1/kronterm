...
import { findGroup } from '@hermes/components/pane-shell/tree/model'
import { $activeTreeGroup, $layoutTree, revealTreePane } from '@hermes/components/pane-shell/tree/store'
import { FileTypeIcon } from '@hermes/components/ui/file-type-icon'
import { ToolIcon } from '@hermes/components/ui/tool-icon'
import { $rightRailActiveTabId, type RightRailTabId, selectRightRailTab } from '@hermes/store/layout'
import { $previewTabs, closeRightRailTab, type PreviewTarget } from '@hermes/store/preview'
