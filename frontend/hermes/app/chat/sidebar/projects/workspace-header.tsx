...
import { ActionsContextMenu, ActionsMenu, type MenuKit, renderActionItem } from '@hermes/components/ui/actions-menu'
...
import { copyPath, revealPath } from '@hermes/store/projects'
