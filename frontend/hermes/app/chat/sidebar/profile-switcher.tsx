...
import { ColorSwatches } from '@hermes/components/ui/color-swatches'
import { ContextMenu, ContextMenuContent, ContextMenuItem, ContextMenuTrigger } from '@hermes/components/ui/context-menu'
import { Dialog, DialogContent, DialogFooter, DialogHeader, DialogTitle } from '@hermes/components/ui/dialog'
import { Popover, PopoverAnchor, PopoverContent } from '@hermes/components/ui/popover'
import { ProfileGlyph } from '@hermes/components/ui/profile-glyph'
import { Select, SelectContent, SelectItem, SelectTrigger, SelectValue } from '@hermes/components/ui/select'
import { Tip, Tooltip, TooltipContent, TooltipProvider, TooltipTrigger } from '@hermes/components/ui/tooltip'
import { getProfileSoul, updateProfileSoul } from '@hermes/hermes'
import { useI18n } from '@hermes/i18n'
import { triggerHaptic } from '@hermes/lib/haptics'
import { PROFILE_SWATCHES, profileColorSoft, resolveProfileColor } from '@hermes/lib/profile-color'
import {
  REORDER_DRAG_TRANSITION_CSS,
  REORDER_RAIL_TRANSITION,
  reorderCommitHaptic,
  reorderStepHaptic
} from '@hermes/lib/reorder'
...
import type { ProfileInfo } from '@hermes/types/hermes'
