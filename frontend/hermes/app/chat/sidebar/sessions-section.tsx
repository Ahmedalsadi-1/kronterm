...
import { SidebarPanelLabel } from '@hermes/app/shell/sidebar-label'
...
import type { HermesGitWorktree } from '@hermes/global'
import type { SessionInfo } from '@hermes/hermes'
import { useI18n } from '@hermes/i18n'
import { flattenSessionsWithBranches } from '@hermes/lib/session-branch-tree'
import {
  groupEntriesByRecency,
  groupEntriesByStatus,
  type SidebarListRow,
  toSessionRows
} from '@hermes/lib/session-date-groups'
import { sessionBucketLabel } from '@hermes/lib/time'
import { cn } from '@hermes/lib/utils'
import { sessionPinId } from '@hermes/store/session'
import { $sessionDotStateById, hasLiveTurn } from '@hermes/store/session-dot-state'
