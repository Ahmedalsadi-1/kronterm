...
import { queryAllVisible } from '@hermes/components/pane-shell/pane-visibility'
...
import {
  ...
  type StripSnapshot,
  subZonePosition
} from '@hermes/components/pane-shell/tree/renderer/drag-session'
import {
  $layoutTree,
  $treeDragging,
  type DropHint,
...
import type { EngineZone, ZoneRect } from '@hermes/components/pane-shell/tree/zones-engine'
import { openSessionTile, type TileDock } from '@hermes/store/session-states'
