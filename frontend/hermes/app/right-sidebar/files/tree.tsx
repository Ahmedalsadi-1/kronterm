...
import { TreeSkeleton } from '@hermes/components/chat/skeletons'
import { Codicon } from '@hermes/components/ui/codicon'
import { markRightPanePerf } from '@hermes/debug/right-pane-events'
import { useResizeObserver } from '@hermes/hooks/use-resize-observer'
import { cn } from '@hermes/lib/utils'
import { type RepoChangeKind, repoChangeKindForPath } from '@hermes/store/coding-status'
import { $renamingPath, beginInlineRename } from '@hermes/store/file-actions'
import { $revealInTreeRequest } from '@hermes/store/layout'
