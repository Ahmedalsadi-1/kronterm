...
import { SETTINGS_ROUTE } from '@hermes/app/routes'
import { Alert, AlertDescription } from '@hermes/components/ui/alert'
import { ConfirmDialog } from '@hermes/components/ui/confirm-dialog'
import { DialogHeader, DialogTitle } from '@hermes/components/ui/dialog'
import { GenerateButton } from '@hermes/components/ui/generate-button'
import { Input } from '@hermes/components/ui/input'
import { useI18n } from '@hermes/i18n'
import { triggerHaptic } from '@hermes/lib/haptics'
import { Egg, ImageIcon } from '@hermes/lib/icons'
...
import {
  ...
  hatchSelected,
  markRemixConfirmed
} from '@hermes/store/pet-generate'
