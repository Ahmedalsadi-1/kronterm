...
const SYSTEM_MONO = '"JetBrains Mono", "SF Mono", Menlo, Monaco, Consolas, monospace, ' + EMOJI_FALLBACK;
...
/**
 * Nous — canonical Hermes desktop identity. Neutral surfaces keep content
 * dominant while the original blue remains the single brand-accent seed.
 */
export const nousTheme: DesktopTheme = {
    ...
    darkColors: {
        ...
        sidebarBorder: "#242429",
        userBubble: "#18181B",
        userBubbleBorder: "#303037",
    },
    typography: {
