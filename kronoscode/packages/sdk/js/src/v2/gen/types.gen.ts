...
export type EventTuiReasoningStart = {
  type: "tui.reasoning.start"
  properties: {
    messageID: string
    reasoning: string
  }
...
export type EventTuiReasoningUpdate = {
  type: "tui.reasoning.update"
  properties: {
    messageID: string
    reasoning: string
    delta: string
...
export type EventTuiReasoningComplete = {
  type: "tui.reasoning.complete"
  properties: {
    messageID: string
    reasoning: string
    duration: number
...
export type EventTuiReasoningPathSelect = {
  type: "tui.reasoning.path.select"
  properties: {
    messageID: string
    path: Array<string>
  }
...
export type Event =
  ...
  | EventTuiReasoningStart
  | EventTuiReasoningUpdate
  | EventTuiReasoningComplete
  | EventTuiReasoningPathSelect
...
export type AgentConfig = {
  ...
  hidden?: boolean
  /**
   * Version for this agent contract; use to enforce runtime capability/fallback compatibility
   */
  schema_version?: number
  /**
   * Declared agent capabilities used by routing and validation (for example: browser, code, desktop-control)
   */
  capabilities?: Array<string>
  /**
   * Explicit capability packs that determine the agent's tool distribution.
   */
  tool_packs?: Array<string>
  /**
   * Explicit tool IDs to add even when they are outside the selected capability packs.
   */
  tools_add?: Array<string>
  /**
   * Explicit tool IDs to remove even when they would otherwise be granted by the selected capability packs.
   */
  tools_remove?: Array<string>
  /**
   * MCP servers required for optimal agent behavior; used for startup diagnostics and fallback policy
   */
  required_mcp?: Array<string>
  /**
   * Fallback behavior contract when dependencies or runtime capabilities are unavailable
   */
  fallback?: {
    /**
     * Preferred fallback runtime mode when required dependencies are unavailable
     */
    mode?: "off" | "browseros" | "desktop-browser" | "e2b" | "openbrowser" | "user-desktop"
    /**
     * User-visible fallback reason template
     */
    reason?: string
  }
  options?: {
...
export type Config = {
  ...
  /**
   * Internal: Quarantined MCP configurations
   */
  mcpPolicyQuarantine?: {
    [key: string]: unknown
  }
...
export type Agent = {
  ...
  capabilities?: Array<string>
  toolPacks?: Array<string>
  toolsAdd?: Array<string>
  toolsRemove?: Array<string>
  requiredMcp?: Array<string>
  fallback?: {
    mode?: "off" | "browseros" | "desktop-browser" | "e2b" | "openbrowser" | "user-desktop"
    reason?: string
  }
...
export type ToolCapabilitiesData = {
  body?: never
  path?: never
  query?: {
    directory?: string
  }
  url: "/experimental/tool/capabilities"
}

export type ToolCapabilitiesErrors = {
  /**
   * Bad request
   */
  400: BadRequestError
...
export type ToolCapabilitiesError = ToolCapabilitiesErrors[keyof ToolCapabilitiesErrors]

export type ToolCapabilitiesResponses = {
  /**
   * Tool capabilities
   */
  200: Array<{
    id: string
    source: "builtin" | "plugin" | "marketplace" | "mcp"
    connector: string
    packs: Array<string>
    risk_level: "low" | "medium" | "high"
    interactive: boolean
...
export type ToolCapabilitiesResponse = ToolCapabilitiesResponses[keyof ToolCapabilitiesResponses]

export type ToolScorecardData = {
  body?: never
  path?: never
  query?: {
    directory?: string
  }
  url: "/experimental/tool/scorecard"
}

export type ToolScorecardErrors = {
  /**
   * Bad request
   */
  400: BadRequestError
...
export type ToolScorecardError = ToolScorecardErrors[keyof ToolScorecardErrors]

export type ToolScorecardResponses = {
  /**
  ...
  200: Array<{
    ...
    source: "builtin" | "mcp"
    connector: string
    required_auth_env: Array<string>
    risk_level: "low" | "medium" | "high"
    health_status: "healthy" | "degraded" | "unavailable"
    verification_strategy: string
    promotion_status: "builtin" | "builtin-adjacent" | "mcp-approved" | "mcp-hidden"
    interactive: boolean
    fallback: Array<string>
  }>
}

export type ToolScorecardResponse = ToolScorecardResponses[keyof ToolScorecardResponses]

export type RoutingTraceData = {
  body?: never
  path?: never
  query?: {
    directory?: string
  ...
  url: "/experimental/routing/trace"
}

export type RoutingTraceErrors = {
  /**
   * Bad request
   */
  400: BadRequestError
...
export type RoutingTraceError = RoutingTraceErrors[keyof RoutingTraceErrors]

export type RoutingTraceResponses = {
  /**
   * Routing trace
   */
  200: {
...
export type RoutingTraceResponse = RoutingTraceResponses[keyof RoutingTraceResponses]
...
export type ExperimentalBrowserActionData = {
  body?:
    ...
    | {
        sessionID: string
        action: "kronoschamber_browser_new_page"
        payload?: {
          url?: string
          timeout?: number
          [key: string]: unknown | string | number | undefined
    ...
    | {
        sessionID: string
        action: "kronoschamber_browser_navigate"
        payload?: {
          type?: "url" | "back" | "forward" | "reload"
          url?: string
          timeout?: number
    ...
    | {
        sessionID: string
        action: "kronoschamber_browser_select_page"
        payload?: {
          pageIdx?: number
          [key: string]: unknown | number | undefined
        }
    ...
    | {
        sessionID: string
        action: "kronoschamber_browser_close_page"
        payload?: {
          pageIdx?: number
          [key: string]: unknown | number | undefined
        }
    ...
    | {
        sessionID: string
        action: "kronoschamber_browser_back"
        payload?: {
          [key: string]: unknown
        }
      }
    | {
        sessionID: string
        action: "kronoschamber_browser_forward"
        payload?: {
          [key: string]: unknown
        }
      }
    | {
        sessionID: string
        action: "kronoschamber_browser_reload"
        payload?: {
          [key: string]: unknown
        }
      }
    | {
        sessionID: string
        action: "kronoschamber_browser_stop"
        payload?: {
          [key: string]: unknown
        }
      }
    | {
        sessionID: string
        action: "kronoschamber_browser_wait_for"
        payload?: {
          text: string
          timeout?: number
          [key: string]: unknown | string | number | undefined
    ...
    | {
        sessionID: string
        action: "kronoschamber_browser_resize"
        payload?: {
          width?: number
          height?: number
          [key: string]: unknown | number | undefined
    ...
    | {
        sessionID: string
        action: "kronoschamber_browser_handle_dialog"
        payload?: {
          action?: "accept" | "dismiss"
          promptText?: string
          [key: string]: unknown | "accept" | "dismiss" | string | undefined
    ...
    | {
        sessionID: string
        action: "kronoschamber_browser_click"
        payload?: {
          uid?: string
          selector?: string
          button?: "left" | "right" | "middle"
    ...
    | {
        sessionID: string
        action: "kronoschamber_browser_hover"
        payload?: {
          uid?: string
          selector?: string
          [key: string]: unknown | string | undefined
    ...
    | {
        sessionID: string
        action: "kronoschamber_browser_fill"
        payload?: {
          uid?: string
          selector?: string
          value?: string
    ...
    | {
        sessionID: string
        action: "kronoschamber_browser_fill_form"
        payload?: {
          fields?: Array<{
            uid?: string
            selector?: string
    ...
    | {
        sessionID: string
        action: "kronoschamber_browser_drag"
        payload?: {
          sourceUid?: string
          sourceSelector?: string
          targetUid?: string
    ...
    | {
        sessionID: string
        action: "kronoschamber_browser_press_key"
        payload?: {
          key?: string
          [key: string]: unknown | string | undefined
        }
    ...
    | {
        sessionID: string
        action: "kronoschamber_browser_upload_file"
        payload?: {
          uid?: string
          selector?: string
          files?: Array<string>
    ...
    | {
        sessionID: string
        action: "kronoschamber_browser_snapshot"
        payload?: {
          [key: string]: unknown
        }
      }
    | {
        sessionID: string
        action: "kronoschamber_browser_screenshot"
        payload?: {
          fullPage?: boolean
          [key: string]: unknown | boolean | undefined
        }
    ...
    | {
        sessionID: string
        action: "kronoschamber_browser_evaluate"
        payload?: {
          script?: string
          [key: string]: unknown | string | undefined
        }
    ...
    | {
        sessionID: string
        action: "kronoschamber_browser_network_requests"
        payload?: {
          limit?: number
          [key: string]: unknown | number | undefined
        }
    ...
    | {
        sessionID: string
        action: "kronoschamber_browser_network_request"
        payload?: {
          index?: number
          urlContains?: string
          [key: string]: unknown | number | string | undefined
    ...
    | {
        sessionID: string
        action: "kronoschamber_browser_console"
        payload?: {
          limit?: number
          [key: string]: unknown | number | undefined
        }
    ...
    | {
        sessionID: string
        action: "kronoschamber_browser_console_message"
        payload?: {
          index?: number
          [key: string]: unknown | number | undefined
        }
    ...
    | {
        sessionID: string
        action: "kronoschamber_browser_emulate"
        payload?: {
          width?: number
          height?: number
          colorScheme?: "light" | "dark" | "no-preference"
    ...
    | {
        sessionID: string
        action: "kronoschamber_browser_perf_start"
        payload?: {
          [key: string]: unknown
        }
      }
    | {
        sessionID: string
        action: "kronoschamber_browser_perf_stop"
        payload?: {
          [key: string]: unknown
        }
      }
    | {
        sessionID: string
        action: "kronoschamber_browser_perf_insight"
        payload?: {
          [key: string]: unknown
        }
      }
...
export type SessionResumeLastObjectiveData = {
  body?: {
    directory?: string
  }
  path?: never
  ...
  url: "/session/resume_last_objective"
}

export type SessionResumeLastObjectiveErrors = {
  /**
   * Bad request
   */
  400: BadRequestError
...
export type SessionResumeLastObjectiveError = SessionResumeLastObjectiveErrors[keyof SessionResumeLastObjectiveErrors]

export type SessionResumeLastObjectiveResponses = {
  /**
   * Resume snapshot
   */
  200: {
...
export type SessionResumeLastObjectiveResponse =
  SessionResumeLastObjectiveResponses[keyof SessionResumeLastObjectiveResponses]
...
export type WorkflowPlaybookListData = {
  body?: never
  path?: never
  query?: {
    directory?: string
  }
  url: "/workflow/playbook"
}

export type WorkflowPlaybookListResponses = {
  /**
   * Workflow playbooks
   */
  200: Array<WorkflowPlaybook>
}

export type WorkflowPlaybookListResponse = WorkflowPlaybookListResponses[keyof WorkflowPlaybookListResponses]
...
export type WorkflowRunActiveData = {
  body?: never
  path?: never
  query?: {
    directory?: string
  ...
  url: "/workflow/run/active"
}

export type WorkflowRunActiveErrors = {
  /**
   * Bad request
   */
  400: BadRequestError
...
export type WorkflowRunActiveError = WorkflowRunActiveErrors[keyof WorkflowRunActiveErrors]

export type WorkflowRunActiveResponses = {
  /**
   * Active workflow runs
   */
  200: Array<ActiveWorkflowRun>
}

export type WorkflowRunActiveResponse = WorkflowRunActiveResponses[keyof WorkflowRunActiveResponses]
...
export type MarketplaceGetEntryData = {
  body?: never
  path: {
    id: string
  }
  ...
  url: "/marketplace/entries/{id}"
}

export type MarketplaceGetEntryErrors = {
  /**
   * Entry not found
   */
  404: {
...
export type MarketplaceGetEntryError = MarketplaceGetEntryErrors[keyof MarketplaceGetEntryErrors]

export type MarketplaceGetEntryResponses = {
  /**
   * Marketplace entry
   */
  200: {
...
export type MarketplaceGetEntryResponse = MarketplaceGetEntryResponses[keyof MarketplaceGetEntryResponses]
...
export type MarketplaceInstallData = {
  ...
  url: "/marketplace/integrations/{id}/install"
}
...
export type MarketplaceListInstalledData = {
  body?: never
  path?: never
  query?: {
    directory?: string
...
export type MarketplaceListInstalledResponses = {
  /**
...
export type MarketplaceListInstalledResponse =
  MarketplaceListInstalledResponses[keyof MarketplaceListInstalledResponses]

export type MarketplaceInstallFromBodyData = {
  body?: {
...
export type MarketplaceInstallFromBodyErrors = {
  /**
   * Bad request
   */
  400: BadRequestError
...
export type MarketplaceInstallFromBodyError = MarketplaceInstallFromBodyErrors[keyof MarketplaceInstallFromBodyErrors]

export type MarketplaceInstallFromBodyResponses = {
  /**
   * Install request accepted
   */
  202: {
...
export type MarketplaceInstallFromBodyResponse =
  MarketplaceInstallFromBodyResponses[keyof MarketplaceInstallFromBodyResponses]

export type MarketplaceRemoveInstalledData = {
  body?: never
  path: {
    id: string
  }
  ...
  url: "/marketplace/integrations/{id}"
}

export type MarketplaceRemoveInstalledErrors = {
  /**
   * Bad request
   */
  400: BadRequestError
...
export type MarketplaceRemoveInstalledError = MarketplaceRemoveInstalledErrors[keyof MarketplaceRemoveInstalledErrors]

export type MarketplaceRemoveInstalledResponses = {
  /**
   * Removed
   */
  200: {
...
export type MarketplaceRemoveInstalledResponse =
  MarketplaceRemoveInstalledResponses[keyof MarketplaceRemoveInstalledResponses]

export type DesktopListSessionsData = {
  body?: never
  path?: never
  query?: {
    directory?: string
  }
  url: "/marketplace/desktop/sessions"
}

export type DesktopListSessionsResponses = {
  /**
   * Desktop sessions and provisioning state
   */
  200: {
...
export type DesktopListSessionsResponse = DesktopListSessionsResponses[keyof DesktopListSessionsResponses]

export type DesktopCreateSessionData = {
  body?: {
    sessionType: "browser" | "terminal" | "desktop"
...
export type DesktopCreateSessionErrors = {
  /**
   * Bad request
   */
  400: BadRequestError
...
export type DesktopCreateSessionError = DesktopCreateSessionErrors[keyof DesktopCreateSessionErrors]

export type DesktopCreateSessionResponses = {
  /**
...
export type DesktopCreateSessionResponse = DesktopCreateSessionResponses[keyof DesktopCreateSessionResponses]

export type DesktopGetSessionData = {
  body?: never
  path: {
    id: string
  }
  ...
  url: "/marketplace/desktop/sessions/{id}"
}

export type DesktopGetSessionErrors = {
  /**
   * Not found
   */
  404: NotFoundError
...
export type DesktopGetSessionError = DesktopGetSessionErrors[keyof DesktopGetSessionErrors]

export type DesktopGetSessionResponses = {
  /**
   * Desktop session
   */
  200: {
...
export type DesktopGetSessionResponse = DesktopGetSessionResponses[keyof DesktopGetSessionResponses]

export type DesktopTakeoverSessionData = {
  body?: never
  path: {
    id: string
  }
  ...
  url: "/marketplace/desktop/sessions/{id}/takeover"
}

export type DesktopTakeoverSessionErrors = {
  /**
   * Not found
   */
  404: NotFoundError
...
export type DesktopTakeoverSessionError = DesktopTakeoverSessionErrors[keyof DesktopTakeoverSessionErrors]

export type DesktopTakeoverSessionResponses = {
  /**
   * Takeover result
   */
  200: {
...
export type DesktopTakeoverSessionResponse = DesktopTakeoverSessionResponses[keyof DesktopTakeoverSessionResponses]

export type DesktopReleaseSessionData = {
  body?: never
  path: {
    id: string
  }
  ...
  url: "/marketplace/desktop/sessions/{id}/release"
}

export type DesktopReleaseSessionErrors = {
  /**
   * Not found
   */
  404: NotFoundError
...
export type DesktopReleaseSessionError = DesktopReleaseSessionErrors[keyof DesktopReleaseSessionErrors]

export type DesktopReleaseSessionResponses = {
  /**
   * Takeover released
   */
  200: {
...
export type DesktopReleaseSessionResponse = DesktopReleaseSessionResponses[keyof DesktopReleaseSessionResponses]

export type CopilotN8nChatData = {
  body?: {
    sessionId?: string
    userId?: string
  ...
  url: "/copilot/n8n/chat"
}

export type CopilotN8nChatErrors = {
  /**
   * Bad request
   */
  400: BadRequestError
...
export type CopilotN8nChatError = CopilotN8nChatErrors[keyof CopilotN8nChatErrors]

export type CopilotN8nChatResponses = {
  /**
   * Kronos copilot response
   */
  200: {
    sessionId: string
...
export type CopilotN8nChatResponse = CopilotN8nChatResponses[keyof CopilotN8nChatResponses]
...
export type AppSkillsPrewarmData = {
  body?: {
    cwd?: string
    agent?: string
    reason?: "prompt_send" | "agent_switch" | "manual"
  }
  path?: never
  query?: {
    directory?: string
...
export type AppSkillsPrewarmResponses = {
  /**
   * Prewarm result
   */
  200: {
...
export type AppSkillsPrewarmResponse = AppSkillsPrewarmResponses[keyof AppSkillsPrewarmResponses]
